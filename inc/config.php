 ...
 */
	...
	// $config['additional_javascript'][] = 'js/Tinyboard-master/style-select.js';
 ...
 */
	...
	// $config['url_stylesheet'] = 'http://static.example.org/Tinyboard-master/style.css'; // main/base stylesheet
