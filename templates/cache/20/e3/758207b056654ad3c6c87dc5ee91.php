...
/* main.js */
class __TwigTemplate_20e3758207b056654ad3c6c87dc5ee91 extends Twig_Template
{
...
var selectedstyle = '";
        ...
        echo addslashes($this->getAttribute($this->getAttribute($_config_, "default_stylesheet"), 0));
        // line 30
        echo "';
var styles = {
\t";
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["stylesheet"]) {
            ...
            echo addslashes($this->getAttribute($_stylesheet_, "name"));
            echo "' : '";
            if (isset($context["stylesheet"])) { $_stylesheet_ = $context["stylesheet"]; } else { $_stylesheet_ = null; }
            echo addslashes($this->getAttribute($_stylesheet_, "uri"));
            // line 32
            echo "',
\t";
        }
...
\t";
        // line 38
        if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
        if ($this->getAttribute($_config_, "stylesheets_board")) {
            // line 43
            echo "
\t\tif (board_name) {
...
";
        ...
        if ($this->getAttribute($_config_, "stylesheets_board")) {
            ...
            if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
            echo strtr($this->getAttribute($this->getAttribute($_config_, "dir"), "res"), array("/" => "\\/"));
            if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
            echo strtr($this->getAttribute($_config_, "file_page"), array("%d" => "\\d+", "." => "\\."));
            echo "|";
            if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
            echo strtr($this->getAttribute($_config_, "file_index"), array("." => "\\."));
            echo "|";
            if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
            echo strtr($this->getAttribute($_config_, "file_page"), array("%d" => "\\d+", "." => "\\."));
            echo ")/);
...
\tvar chars = '";
        if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
        echo $this->getAttribute($_config_, "genpassword_chars");
        // line 221
        echo "';
\tfor (var i = 0; i < 8; i++) {
...
\t\t\tif (get_cookie('";
        if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
        echo $this->getAttribute($this->getAttribute($_config_, "cookies"), "js");
        // line 223
        echo "')) {
...
";
        if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
        if ($this->getAttribute($_config_, "google_analytics")) {
            // line 273
            echo "

var _gaq = _gaq || [];_gaq.push(['_setAccount', '";
            if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
            echo $this->getAttribute($_config_, "google_analytics");
            echo "']);";
            if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
            if ($this->getAttribute($_config_, "google_analytics_domain")) {
                echo "_gaq.push(['_setDomainName', '";
                if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
                echo $this->getAttribute($_config_, "google_analytics_domain");
                echo "'])";
            }
            if (isset($context["config"])) { $_config_ = $context["config"]; } else { $_config_ = null; }
            if ((!$this->getAttribute($_config_, "google_analytics_domain"))) {
...
";
    ...
    {
        return array (  392 => 274,  372 => 273,  326 => 271,  316 => 229,  310 => 223,  244 => 221,  189 => 159,  175 => 106,  173 => 97,  150 => 95,  136 => 76,  134 => 75,  131 => 74,  100 => 73,  98 => 46,  94 => 44,  86 => 43,  83 => 38,  74 => 37,  67 => 32,  56 => 31,  50 => 30,  19 => 28,);
    }
}
